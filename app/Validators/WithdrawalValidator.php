 ...
 * اعتبارسنجی بیزینسی → WithdrawalService::guardCanCreateWithdrawal()
 *
...
class WithdrawalValidator extends Validator
{
    ...
    {
        trigger_error('WithdrawalValidator is deprecated. Use CreateWithdrawalRequest + WithdrawalService::guardCanCreateWithdrawal() instead.', E_USER_DEPRECATED);
