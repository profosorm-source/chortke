...
public function globalStats(): object
{
    ...
    // ==================== ANALYTICS METHODS MOVED FROM SERVICE ====================

    public function getReferralTrend(int $userId, int $days): array
    {
        $sql = "SELECT DATE(referred_at) as date, COUNT(*) as count, SUM(commission_amount) as total_commission
                FROM referral_commissions
    ...
    public function getConversionRate(int $userId, int $days): ?object
    {
    ...
    public function getTopMonthlyReferrer(): ?object
    {
