...
class ErrorContract
{
    ...
    public const CODE_APPEAL_LIMIT_EXCEEDED = 'APPEAL_LIMIT_EXCEEDED';
    ...
    /**
     * Static factory for appeal limit exceeded
     */
    public static function appealLimitExceeded(string $message = 'Appeal limit exceeded'): self
    {
        return new self(
            self::STATUS_RATE_LIMITED,
            self::CODE_APPEAL_LIMIT_EXCEEDED,
            $message
        );
    }
