...
class AnalyticsExporter extends \App\Services\BaseService
{
    ...
    public function generatePDF(array $data): void
    {
        ...
        <body>
            ...
            <table>
                ...
                <tr><td>کل کاربران</td><td><?= $data['users']['total'] ?? 0 ?></td></tr>
                <tr><td>کاربران فعال</td><td><?= $data['users']['active'] ?? 0 ?></td></tr>
                <tr><td>DAU</td><td><?= $data['users']['dau'] ?? 0 ?></td></tr>
                <tr><td>MAU</td><td><?= $data['users']['mau'] ?? 0 ?></td></tr>
            </table>
            <?php endif; ?>
    ...
    private function generateExcelHTML(array $data): string
    {
        ...
        if (!empty($data['users'])) {
            ...
            $html .= '<tr><td>کل کاربران</td><td>' . ($data['users']['total'] ?? 0) . '</td></tr>';
            $html .= '<tr><td>کاربران فعال</td><td>' . ($data['users']['active'] ?? 0) . '</td></tr>';
        }
