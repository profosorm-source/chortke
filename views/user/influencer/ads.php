...
<div class="content-header d-flex justify-content-between align-items-center">
  ...
  <a href="<?= url('/influencer/ads/my-orders') ?>" class="btn btn-outline-secondary btn-sm">
...
<div class="card mt-3">
  <div class="card-body py-2">
    <form method="GET" action="<?= url('/influencer/ads') ?>">
        ...
        <tbody>
          ...
          <tr class="influencer-row" style="cursor:pointer;"
            ...
            <td class="text-center" onclick="event.stopPropagation()">
              <a href="<?= url('/influencer/ads/create?influencer_id=' . (int)$p->id) ?>"
