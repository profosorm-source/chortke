...
if (!function_exists('db')) {
    ...
    {
        return app()->container->make(\Core\Database::class);
    }
}
...
if (!function_exists('settings')) {
    function settings(bool $forceReload = false): array
    {
        ...
        $settings = app()->container->make(\App\Services\SettingService::class)->load();
...
if (!function_exists('logger')) {
    ...
    {
        return app()->container->make(\App\Contracts\LoggerInterface::class);
    }
}
